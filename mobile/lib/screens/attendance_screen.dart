...
class _AttendanceScreenState extends State<AttendanceScreen> {
  ...
  // 📍 SWAP THESE NUMBERS TO TEST INSIDE/OUTSIDE RADIUS
  // Currently set to INSIDE the office (25.133582, 55.387712)
  final double mockLatitude = 25.135000;
  final double mockLongitude = 55.387712;
  ...
  Widget build(BuildContext context) {
    return Scaffold(
      appBar: AppBar(
        title: const Text('Geofence Manual Test'),
        centerTitle: true,
