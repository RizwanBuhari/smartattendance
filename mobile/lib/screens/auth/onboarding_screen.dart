          ...
          child: Column(
            ...
            children: [
                ...
                builder: (context, child) {
                  return Opacity(
                    ...
                    child: Transform.translate(
                      offset: _cardOffset.value * MediaQuery.of(context).size.height,
                      child: child,
                    ),
                  );
                },
                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            ...
                            transform: Matrix4.identity()
                              ..scaleByDouble(_isRegisterPressed ? 0.98 : 1.0, _isRegisterPressed ? 0.98 : 1.0, 1.0, 1.0),
                            height: 60,
                            decoration: BoxDecoration(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.people_outline, color: AppColors.white, size: 24),
                                ...
                                AnimatedContainer(
                                  duration: const Duration(milliseconds: 100),
                                  margin: EdgeInsets.only(left: _isRegisterPressed ? 3 : 0),
                      ...
                      AnimatedBuilder(
                        ...
                        child: GestureDetector(
                          ...
                          child: AnimatedContainer(
                            duration: const Duration(milliseconds: 100),
                            transform: Matrix4.identity()
                              ..scaleByDouble(_isLoginPressed ? 0.98 : 1.0, _isLoginPressed ? 0.98 : 1.0, 1.0, 1.0),
                            height: 60,
                            decoration: BoxDecoration(
                            ...
                            child: Row(
                              children: [
                                const Icon(Icons.login_outlined, color: AppColors.brandRed, size: 24),
                                const SizedBox(width: 12),
                                const Expanded(
                                  child: Text(
                                    'Login',
                                ...
                                AnimatedContainer(
                                  duration: const Duration(milliseconds: 100),
                                  margin: EdgeInsets.only(left: _isLoginPressed ? 3 : 0),
                                  child: const Icon(Icons.chevron_right, color: AppColors.brandRed, size: 20),
                                ),
                              ],
                            ),
                          ),
              ...
              AnimatedBuilder(
                ...
                builder: (context, child) {
                  return Opacity(
                    opacity: _securityOpacity.value,
                    child: child,
                  );
                },
                child: Row(
